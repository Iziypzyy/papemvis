...
Public Class FormUser
    ...
    Public Sub LoadDataDB()
        ...
        Try
            Using conn As MySqlConnection = GetConnection()
                ...
                Dim query As String =
                    "SELECT username, nama_lengkap, level, status, created_at 
                     FROM users 
                     ORDER BY id_user"
        ...
        Catch ex As Exception
            ...
            MessageBox.Show(
                "Gagal memuat data user!" & vbCrLf & ex.Message,
                "Error",
    ...
    Private Sub btnTambah_Click(sender As Object, e As EventArgs) Handles btnTambah.Click
        ...
        Try
            ...
            Using conn As MySqlConnection = GetConnection()
                ...
                Dim query As String =
                    "INSERT INTO users 
                    (username, nama_lengkap, password, level, status) 
                    VALUES 
                    (@user, @nama, '12345', @level, @status)"
            ...
            MessageBox.Show(
                "Data user berhasil ditambahkan! Password default: 12345",
                "Berhasil",
                MessageBoxButtons.OK,
        ...
        Catch ex As Exception
            ...
            MessageBox.Show(
                "Gagal menambah user!" & vbCrLf & ex.Message,
                "Error",
                MessageBoxButtons.OK,
                MessageBoxIcon.Error
            )
    ...
    Private Sub btnUbah_Click(sender As Object, e As EventArgs) Handles btnUbah.Click
        ...
        Catch ex As Exception
            ...
            MessageBox.Show(
                "Gagal mengubah user!" & vbCrLf & ex.Message,
                "Error",
                MessageBoxButtons.OK,
                MessageBoxIcon.Error
            )
    ...
    Private Sub btnHapus_Click(sender As Object, e As EventArgs) Handles btnHapus.Click
        ...
        If konfirmasi = DialogResult.Yes Then
            ...
            Dim username As String =
                dgvUsers.CurrentRow.Cells("colUsername").Value.ToString()
            ...
            Catch ex As Exception
                ...
                MessageBox.Show(
                    "Gagal menghapus user!" & vbCrLf & ex.Message,
                    "Error",
                    MessageBoxButtons.OK,
                    MessageBoxIcon.Error
                )
    ...
    Private Sub btnResetPassword_Click(sender As Object, e As EventArgs) Handles btnResetPassword.Click
        ...
        If txtUsername.Text = "" Then
            ...
            MessageBox.Show(
                "Pilih user yang ingin di-reset password!",
                "Peringatan",
                MessageBoxButtons.OK,
                MessageBoxIcon.Warning
            )
        ...
        If konfirmasi = DialogResult.Yes Then
            ...
            Catch ex As Exception
                ...
                MessageBox.Show(
                    "Gagal reset password!" & vbCrLf & ex.Message,
                    "Error",
                    MessageBoxButtons.OK,
                    MessageBoxIcon.Error
                )
    ...
    Private Sub txtCari_TextChanged(sender As Object, e As EventArgs) Handles txtCari.TextChanged
        ...
        For Each row As DataGridViewRow In dgvUsers.Rows
            ...
            Dim nama As String =
                row.Cells("colNamaLengkap").Value.ToString().ToLower()

            Dim level As String =
                row.Cells("colLevel").Value.ToString().ToLower()
