...
Public Class FormDashboard
    ...
    Private Sub LoadDashboard()
        ...
        Try
                    ...
                    Using dr As MySqlDataReader = cmd.ExecuteReader()
                        ...
                        If dr.Read() Then
                            ...
                            LabelProdukValue.Text =
                                dr("total_produk").ToString()

                            LabelStokValue.Text =
                                dr("produk_stok_menipis").ToString()

                            LabelPenjualanValue.Text =
                                "Rp " & Format(
                                    Convert.ToDouble(dr("penjualan_hari_ini")),
                                    "###,###,##0"
                                )

                            LabelPelangganValue.Text =
                                dr("total_pelanggan").ToString()
            ...
            LabelNotif2.Text =
                "- 2 pesanan pembelian belum diterima"
    ...
    Private Sub LoadTopProduk()
                ...
                Using cmd As New MySqlCommand(query, conn)
                    ...
                    Using dr As MySqlDataReader = cmd.ExecuteReader()
                        ...
                        While dr.Read()
                            ...
                            TableTopProduk.Controls.Add(
                                BuatLabelTable(no.ToString()),
                                0,
                                no
                            )

                            TableTopProduk.Controls.Add(
                                BuatLabelTable(dr("nama_barang").ToString()),
                                1,
                                no
                            )

                            TableTopProduk.Controls.Add(
                                BuatLabelTable(dr("total_terjual").ToString()),
                                2,
                                no
                            )
        ...
        Catch ex As Exception
            ...
            TableTopProduk.Controls.Add(BuatLabelTable("Tidak ada data"), 1, 1)
    ...
    Private Function BuatLabelTable(
        teks As String,
